...
2. At the DAC output, our signal is going to be centered at $1.65 V$, we send our signal through a capacitor to recenter it at $0 V$. Also, we use an RC high-pass filter to attenuate the high frequency switching noise.
